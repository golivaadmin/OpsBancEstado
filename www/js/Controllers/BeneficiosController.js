app.controller('BeneficiosController', function($scope,$state) {
    ...
    $scope.beneficios = [
        { titulo : "EDUCACIÓN", cantidad:3 , src:"http://localhost:8100/img/top-noticias.png" },
        { titulo : "VACACIONES", cantidad:4 ,src:"http://localhost:8100/img/top-noticias.png" },
        { titulo : "FAMILIA", cantidad:2 ,src:"http://localhost:8100/img/top-noticias.png" },
        { titulo : "DEPORTE", cantidad:4 ,src:"http://localhost:8100/img/top-noticias.png" }
    ];
